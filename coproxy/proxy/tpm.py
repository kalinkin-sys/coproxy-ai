...
class TPMDispatcher:
    ...
    def __init__(self, limit: int, timeout: float = 120.0) -> None:
        ...
        self._total_direct_hits: int = 0  # aggressive mode bypasses
    ...
    def record_direct(self, tokens: int) -> None:
        """Record tokens used by aggressive mode (bypassed queue)."""
        if tokens > 0:
            self._window.append(_Record(time.monotonic(), tokens, ""))
            self._total_tokens += tokens
        self._total_direct_hits += 1
        self._total_requests += 1
    ...
    def get_stats(self) -> dict:
        ...
        return {
            ...
            "requests": {
                ...
                "direct_hits": self._total_direct_hits,
            },
            "tokens": {
